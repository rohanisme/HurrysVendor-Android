...
import hurrys.corp.vendor.Models.Product.ProductsAdapter1;
import hurrys.corp.vendor.R;

import static android.app.Activity.RESULT_OK;

public class CreateMealEdit extends Fragment {
    ...
    private ProductsAdapter1 productsAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_create_meal_edit, container, false);
        ...
        products.clear();
        productsAdapter = new ProductsAdapter1(products);
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                            if(dataSnapshot.exists()){
                                                ...
                                                if(dataSnapshot.child("Menu").exists()) {
                                                    for (DataSnapshot v : dataSnapshot.child("Menu").getChildren())
                                                    {
                                                        products.add(new Product((v.child("Name").getValue().toString()),v.child("Required").getValue().toString()+" Required"));
                                                    }

        ...
        FirebaseRecyclerAdapter<Payment, ViewHolder> firebaseRecyclerAdapter =
                new FirebaseRecyclerAdapter<Payment, ViewHolder>(
                    ...
                    protected void populateViewHolder(ViewHolder viewHolder, Payment payment, int position) {
                        viewHolder.setDetailssettlement(getContext(),payment.PushId,payment.UserId,payment.UserBalance,payment.Date,payment.Amount,payment.Generated,payment.TransactionType,payment.TransactionName,payment.TransactionId,payment.Status,payment.OrderPushId);
                    ...
                    protected void onDataChanged() {
                        super.onDataChanged();
                        if(getItemCount()==0){
                            Toast.makeText(getContext(),"No Settlements Found",Toast.LENGTH_LONG).show();
                        }
                    }
